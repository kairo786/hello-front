  ...
  const features = [
    {
      ...
      description: "Enjoy seamless real-time conversations with crystal clear video and audio."
    },
    {
      icon: "https://lottie.host/5dd57e3e-89d7-486b-9945-3b9f4aedb0c1/hRr7XUT6g6.lottie",
      title: "Face Detection with Emojis",
      description: "Smart emotion recognition adds fun by showing emojis based on your expressions (visible only to you)."
    },
    {
      icon: "https://lottie.host/280a2266-7bc0-4f0a-acad-a4ba89b89c06/OpD5OMSedI.lottie",
      title: "Direct Messaging (DMs)",
      description: "Chat instantly with friends alongside your video or audio calls."
    },
    {
      icon: "https://lottie.host/9f11f0ca-8a2f-41e6-b1b4-136dfaa87a5a/F2umAnLIQU.lottie",
      title: "Multi-Language Support",
      description: "Switch your call experience to your favorite language with built-in translation support."
    },
    {
      icon: "https://lottie.host/7aad089d-585d-4f99-869d-eda7ee898f58/SYoiUoDP9L.lottie",
      title: "Interactive Chatbot",
      description: "Get instant answers, guidance, and even humor with our smart AI chatbot."
    },
    {
      icon: "https://lottie.host/626c24f5-5f10-4286-bf52-7cff1c9cf1fe/0H6pZrKbNx.lottie",
      title: "Cross-Device Friendly",
      description: "Optimized for mobile, tablet, and desktop browsers."
    },
    {
      icon: "https://lottie.host/dd8de437-742c-40ea-8594-a39cef464a45/2SJZKXKnaF.lottie",
      title: "Privacy & Security",
      description: "Your conversations are encrypted to keep you safe and secure."
    },
    {
      icon: "https://lottie.host/63c0d911-9ce4-4afc-bb8b-50718ab34a90/vBlsuhW4Ta.lottie",
      title: "Fast & Reliable",
      description: "Quick connections with minimal latency, powered by modern web technologies."
    },
  ];
      ...
      <div className="container relative z-10 px-4 mx-auto">
        ...
        >
          {features.map((feature, i) => (
            ...
            >
              <DotLottieReact   src={feature.icon}  loop autoplay className="w-32 h-30"/>
